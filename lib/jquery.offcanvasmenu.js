...
(function() {
  ...
  $.offCanvasMenu = function(options) {
    var actions, baseCSS, body, cssSupport, head, innerWrapper, menu, menuLeft, outerWrapper, settings, transformPosition, transformPrefix, trigger;
    ...
    baseCSS = "<style>    body.off-canvas-menu .outer-wrapper {      left: 0;      overflow-x: hidden;      position: absolute;      top: 0;      width: 100%;    }    body.off-canvas-menu .inner-wrapper {      position: relative;    }    body.off-canvas-menu " + settings.menu + " {      left: " + menuLeft + ";      margin: 0;      position: absolute;      top: 0;      width: " + settings.coverage + ";    }  </style>";
    head.append(baseCSS);
